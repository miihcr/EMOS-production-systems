...
| Variable     | Validation needed                                 |
|--------------|---------------------------------------------------|
| id_address   | !is.na(id_address)                                |
| house_number | house_number \> 0                                 |
| postcode     | str_detect(postcode, "\^[1-9][0-9]{3}[A-Z]{2}\$") |
| start_valid  | !is.na(start_valid)                               |
| end_valid    | is.na(end_valid) \| end_valid \>= start_valid     |
